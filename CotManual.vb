Public Class CotManual
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim sum As Double
        Cotizacion.DGVDetalle.Rows.Add({ComboBox1.SelectedValue, TextBox1.Text, TextBox2.Text, CDbl(TextBox3.Text), TextBox3.Text * TextBox2.Text})
        For Each dr As DataGridViewRow In Cotizacion.DGVDetalle.Rows
            sum = sum + dr.Cells(4).Value
        Next
        Cotizacion.TextBox4.Text = sum.ToString("$#,##0")
        ing = "No"
        Close()
    End Sub

    Private Sub CotManual_Load(sender As Object, e As EventArgs) Handles MyBase.Load
